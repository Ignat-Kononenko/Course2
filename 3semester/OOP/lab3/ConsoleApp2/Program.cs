...
namespace ConsoleApp1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            MySet<string> sortedSet = set1.SortSet();
            Console.WriteLine("Упорядоченный set1: " + sortedSet);
        ...
        public class MySet<T>
        {
            ...
            public Production prod = new Production(10, "jon");
        ...
        public static class StaticOperation
        {
            ...
            {
                return set.Elements.OrderBy(e => e.Length).FirstOrDefault();
            }
        }
        ...
        public static class StaticOperationExtensions
        {
            ...
            {
                var sortedElements = set.Elements.OrderBy(e => e).ToList();
                return new MySet<string> { Elements = new HashSet<string>(sortedElements) };
            }
        }
    }
}
